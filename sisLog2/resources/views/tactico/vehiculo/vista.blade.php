  ...
  <header class="clearfix">
    <div class="container">
      ...
      <div class="company-info">
        <h2 class="title">sistema de proyecto</h2>
        <div class="address">
        ...
        <div class="email">
          ...
          <a href="mailto:company@example.com">pryoectoA@gmail.com</a>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="row">
      ...
      <div class = "table-responsive">  
        <table class = "table table-striped table-bordered table-condensed table-hover">
          ...
          @foreach ($anys as $any)
            <tbody>
              <th>{{$any->IDVEHICULO}}</th>
                <th>{{$any->MARCAVEHICULO}}</th>
                <th>{{$any->TIPODESPERFECTO}}</th>
            </tbody>
          @endforeach
